...
describe("PlaceMode", () => {
  test("exposes the wire values developers depend on", () => {
...
describe("amountForMode", () => {
  ...
  test("Half uses ceil semantics and never returns 0 for positive counts", () => {
    ...
    expect(amountForMode(5, PlaceMode.Half)).toBe(3);
  });

  test("All returns the full count", () => {
