...
import { Animation, AnimationManager } from "../../../ioengine/lib/animations";
import { lerp, radians } from "../../../ioengine/lib/transforms";
...
function timerAnimation(timer: Timer) {
    ...
    animation.keyframes[1] = (animation) => {
        timer.arc.clear();
        timer.arc.stroke({ width: 10, color: timer.color });
        timer.arc.arc(
            0,
            0,
            50,
